...
public:
	...
	virtual int getWidth()=0; // Width of framebuffer in pixels
	virtual int getHeight()=0; // Height of framebuffer in pixels
	virtual unsigned int _bindInternal()=0; // Only for use in the class Renderer!
	virtual unsigned int getID()=0; // Only for use in the class Renderer!
};
...
#endif /* GRAPHICS_BUFFERS_FBO_HPP_ */
